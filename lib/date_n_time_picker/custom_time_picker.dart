...
class _HourMinuteControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color backgroundColor = timePickerTheme.hourMinuteColor ??
        MaterialStateColor.resolveWith((Set<MaterialState> states) {
          return states.contains(MaterialState.selected)
              ? themeData.colorScheme.primary.withOpacity(isDark ? 0.18 : 0.12)
        ...
        child: Semantics(
          ...
          child: Center(
            child: Text(
              ...
              style: amStyle.copyWith(color: Colors.white),
        ...
        child: Semantics(
          ...
          child: Center(
            child: Text(
              ...
              style: pmStyle.copyWith(color: Colors.white),
              textScaleFactor: buttonTextScaleFactor,
            ),
          ),
        ),
...
class _DialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(centerPoint, radius, Paint()..color = Colors.black);
